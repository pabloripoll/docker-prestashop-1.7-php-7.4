...
<table class="wp-list-table widefat fixed striped table-view-list users">
    <thead><?= $this->view('admin.'.$route['page'].'.'.$route['section'].'.listing-table-head') ?></thead>
    <tbody id="the-list" data-wp-lists="list:user"><?= $this->view('admin.'.$route['page'].'.'.$route['section'].'.listing-table-body', ['users' => []]) ?></tbody>
    <tfoot><?= $this->view('admin.'.$route['page'].'.'.$route['section'].'.listing-table-head', ['table' => ['pre' => 'cb']]) ?></tfoot>
</table>
