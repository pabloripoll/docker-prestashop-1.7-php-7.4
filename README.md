...
- [Prestashop 1.7](https://build.prestashop-project.org/tag/1.7/) - *(latest 1.7 release)*
...
* Uses PHP 7.4 as default for the best performance, low CPU usage & memory footprint
